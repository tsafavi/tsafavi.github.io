...
I am a deep learning engineer at NVIDIA, working on applied research in frontier model co-design for efficient and agentic inference. Previously, I was an applied researcher at Microsoft, spending two years in research (MSR) and two years in the M365 Copilot org. I graduated from the University of Michigan in May 2022 with a PhD in computer science working on graph + text learning with Transformers.
